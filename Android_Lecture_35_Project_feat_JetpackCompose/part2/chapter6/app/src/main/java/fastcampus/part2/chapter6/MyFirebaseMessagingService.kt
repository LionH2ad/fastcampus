...
class MyFirebaseMessagingService: FirebaseMessagingService()  {
    ...
    override fun onMessageReceived(message: RemoteMessage) {
        ...
        val mChannel = NotificationChannel(getString(R.string.default_notification_channel_id), name, importance) // 채널 만들기
        ...
        val body = message.notification?.body ?: "" // 채팅 알림에 보여줄 텍스트 메세지
